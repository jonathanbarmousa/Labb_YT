...
- Viktigt att lägga till .env i din .gitignore-fil för att förhindra att dina credentials läcker på GitHub.
...
- Detta öppnar chatbot och låter dig börja prata med RAGtuber chatboten.

# 5. Distribution till Azure via VSCode
...
- Distribuera: När funktionens app har skapats, kan du distribuera den till Azure, och den kommer att vara tillgänglig i Azure-portalen.